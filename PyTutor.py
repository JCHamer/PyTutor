...
print_code("python");
print_slow("Why don't you go do that now. Press enter when you're ready to continue.");

garbage = raw_input()


print_slow("\n\nNow you've got a personal python interpretor that will run the commands ");
...
print_code("x = 8");
x = 8;
print_slow("Press enter when you're ready to continue");
garbage = raw_input()
...
print_code("x*27");
print_slow("Hopefully, you got 216!");
...
print_code("sqrt(16)");
print_slow("Take a moment and think about what this will give you.\n");
time.sleep(2);
...
print_slow("\nNow, you should have seen a white screen pop up with an arrow in the middle. This arrow is your turtle! 'PyTutor,' you may be saying, 'what in the world are you talking about? This is an ARROW, not a TURTLE!'\n")
